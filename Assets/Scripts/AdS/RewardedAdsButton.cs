...
public class RewardedAdsButton : MonoBehaviour, IUnityAdsLoadListener, IUnityAdsShowListener
{
    ...
    // [SerializeField] GameObject addAvailable;
    ...
    {   
        ...
        //hide the show ad button until the ad is ready to show
    ...
    public void OnUnityAdsAdLoaded(string adUnitId)
    {
        ...
        if (adUnitId.Equals(_adUnitId))
        {
            ...
            // show the button in delay of 1 second
    ...
    // show the button every five minutes with Ienumerator
